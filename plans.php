    ...
    if (!$_REQUEST['raw'] && $plan->plan_id) {
      ?><!DOCTYPE html>
          ...
          <head>
            ...
            <title><?php echo ucwords($plan->plan_name); ?> | Star Verte LLC</title>
          ...
          <div id="masthead" class="fill site-header" role="banner">
            <div class="container">
              <div class="site-branding">
                    ...
                    <h2 class="tagline hidden-xs" style="font-size: 36px;">This is the <?php echo ucwords($plan->plan_name) ?> Plan from Star Verte</h2>

                    <h2 class="tagline visible-xs-block" style="font-size: 24px;">This is the <?php echo ucwords($plan->plan_name) ?> Plan from Star Verte</h2>
