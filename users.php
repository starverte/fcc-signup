          ...
          <div class="fill site-header" id="masthead">
            <div class="container">
              <div class="site-branding">
                <h2 class="tagline hidden-xs" style="font-size: 36px;"><?php echo "$user->user_name_first $user->user_name_last".(!!$user->user_company?"- $user->user_company":'') ?>
                </h2>


                <h2 class="tagline visible-xs-block" style="font-size: 24px;"><?php echo "$user->user_name_first $user->user_name_last".(!!$user->user_company?"- $user->user_company":'') ?>
                </h2>
                ...
                <div class="row">
                  ...
                  <article class="col-xs-12 post-1230 page type-page status-publish hentry" id="post-1230">
                    ...
                    <div class="entry-content">
                      ...
                      <p><?php echo $user->user_address ? 'Address: '.address::get_instance_pretty($user->user_address, false) : "$user->user_name_first $user->user_name_last hasn't entered his/her address yet" ?>
                      </p>
